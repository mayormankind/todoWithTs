...
const changeableContent = document.querySelector('.holder') as HTMLHeadingElement;
let counter = 0;
const greetingContainer = document.querySelector('.greetings') as HTMLElement;
const moment = document.querySelector('.moment') as HTMLSpanElement;
let date = new Date(),
hour = date.getHours(),
...
export function updateStorage(allPlans:any){
